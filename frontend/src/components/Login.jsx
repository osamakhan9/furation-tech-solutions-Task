...
try {
  const data=await axios.post('https://furation-tech.onrender.com/api/auth/login',{email,password},config);
  ...
  return (
   ...
   <h1 className='Heading'>Login</h1>
    <form onSubmit={handleSubmit} className='authForm' >
      ...
      <Link to="/register">Please Registered</Link>
    </form>
   </>
  );
};
