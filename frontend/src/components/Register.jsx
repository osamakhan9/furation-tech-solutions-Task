...
try {
  const data=await axios.post('https://furation-tech.onrender.com/api/auth/register',{name,email,password},config);
  ...
  return (
   <>
    ...
    <form onSubmit={handleSubmit} className='authForm'>
      ...
      <Link to="/login">If You are already Register</Link>
    </form>
